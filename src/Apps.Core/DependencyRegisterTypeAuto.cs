...
//------------------------------------------------------------------------------
			...
			container.RegisterType<Apps.IBLL.EMS.IEMS_DeviceAreaBLL, Apps.BLL.EMS.EMS_DeviceAreaBLL>();
			container.RegisterType<Apps.IDAL.EMS.IEMS_DeviceAreaRepository, Apps.DAL.EMS.EMS_DeviceAreaRepository>();
			container.RegisterType<Apps.IBLL.EMS.IEMS_DeviceDetailsBLL, Apps.BLL.EMS.EMS_DeviceDetailsBLL>();
			container.RegisterType<Apps.IDAL.EMS.IEMS_DeviceDetailsRepository, Apps.DAL.EMS.EMS_DeviceDetailsRepository>();
			container.RegisterType<Apps.IBLL.EMS.IEMS_DeviceStateBLL, Apps.BLL.EMS.EMS_DeviceStateBLL>();
			container.RegisterType<Apps.IDAL.EMS.IEMS_DeviceStateRepository, Apps.DAL.EMS.EMS_DeviceStateRepository>();
			container.RegisterType<Apps.IBLL.EMS.IEMS_DeviceTypeBLL, Apps.BLL.EMS.EMS_DeviceTypeBLL>();
			container.RegisterType<Apps.IDAL.EMS.IEMS_DeviceTypeRepository, Apps.DAL.EMS.EMS_DeviceTypeRepository>();
